...
public class TesseractOCRAnalyzer {

    private static final Logger LOGGER = LoggerFactory.getLogger(TesseractOCRAnalyzer.class);

    private final String tessDataDirectory;
    private final Path imagePath;
    private final String language;

    public TesseractOCRAnalyzer(String tessDataDirectory, Path imagePath, String language) {
    ...
    public List<OcrWord> extractLinesFromImage() {
		...
		try (TessBaseAPI api = new TessBaseAPI();) {
		    ...
		    lines = IntStream.range(0, boxes.n()).mapToObj((int lineSequenceNumber) -> {
				...
				System.err.println(ocrLineText);
    ...
    public String extractHOCRFromImage() {
    ...
    public String extractTextFromImage(int psm) {
